...
public class OfflineManager2 : MonoBehaviour
{
    ...
    void IncreaseRedPiecesOrderInLayer()
    {
        foreach (var piece in redPlayerPiece)
        {
            if (piece.gameObject.activeInHierarchy)
            {
                ...
                if (renderer != null)
                {
                    renderer.sortingOrder += 10; // Increase by 10 to ensure they appear above other pieces
                }
            }
        }
    }
    ...
    //            if (renderer != null)
    //            {
    //                renderer.sortingOrder += 1; // Increase by 1 or whatever value you need
    //            }
    //        }
    //    }
    //}
